...
| 4 | IV | `wsollers/lra-volume-iv` | `Algebra and Abstract Structures` | Emmy Noether | 1882-1935 | `images/noether.png` | planned |
| 5 | V | `wsollers/lra-volume-v` | `Topology and Geometry` | Henri Poincare | 1854-1912 | `images/poincare.png` | planned |
| 6 | VI | `wsollers/lra-volume-vi` | `Computational Mathematics` | Leonhard Euler | 1707-1783 | `images/euler.png` | planned |
| 7 | VII | `wsollers/lra-volume-vii` | `Numerical and Approximation Mathematics` | Isaac Newton | 1643-1727 | `images/newton.png` | planned |
| 8 | VIII | `wsollers/lra-volume-viii` | `Mathematical Logic and Foundations` | David Hilbert | 1862-1943 | `images/hilbert.png` | planned |
