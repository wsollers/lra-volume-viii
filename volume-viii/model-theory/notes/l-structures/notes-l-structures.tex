...
\begin{propositionbox}{Definition (First-Order Language $\mathcal{L}$)}
...
\begin{propositionbox}{Definition ($\mathcal{L}$-Structure)}
...
\begin{propositionbox}{Definition (Variable Assignment)}
...
\begin{propositionbox}{Definition (Term Evaluation)}
