...
\begin{definitionbox}{Definition (Vector in $\mathbb{R}^n$)}
...
\begin{definitionbox}{Definition (Linear Combination)}
...
\begin{remark*}[Exposition]
\textbf{Why convex combinations matter for NURBS.}
...
\begin{definitionbox}{Definition (Standard Basis Vectors)}
\begin{definition}[Standard Basis Vectors]
\label{def:standard-basis-vectors}
