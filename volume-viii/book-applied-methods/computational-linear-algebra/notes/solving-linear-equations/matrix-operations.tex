...
\textbf{Rules for Matrix Multiplication.}
...
\begin{definitionbox}{Definition (Diagonal Matrix)}
\begin{definition}[Diagonal Matrix]
\label{def:diagonal-matrix}
...
\begin{remark*}[Exposition]
\textbf{Block matrix multiplication.}
...
then, provided inner block dimensions match,
\[
  AB = \begin{pmatrix}
