...
\begin{definitionbox}{Definition (Invertible Matrix)}
...
\begin{remark*}[Exposition]
\textbf{NURBS connection: converting between Bernstein and power basis.}
...
The inverse $M^{-1}$ converts the other direction: for a curve in
power basis form with coefficients $[\mathbf{a}_i]$, the equivalent
