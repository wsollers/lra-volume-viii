...
\subsection{The Idea of a Linear Transformation}

% ---------------------------------------------------------
\subsection*{Definition}

\begin{definitionbox}{Definition (Linear Transformation)}
...
\textbf{The origin is always fixed.}
...
\begin{remark*}[Exposition]
\textbf{Composition is matrix multiplication.}
...
\begin{definitionbox}{Definition (Affine Transformation)}
\begin{definition}[Affine Transformation]
\label{def:affine-transformation}
...
\begin{remark*}[Exposition]
\textbf{Affine invariance of B-spline curves --- NURBS Property P3.4.}
