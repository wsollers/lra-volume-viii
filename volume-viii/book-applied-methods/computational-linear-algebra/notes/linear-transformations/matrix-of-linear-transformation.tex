...
\textbf{Standard Matrix of a Linear Transformation.}
...
\begin{definitionbox}{Definition (Matrix Relative to a Basis)}
\begin{definition}[Matrix Relative to a Basis]
\label{def:matrix-relative-to-basis}
...
\begin{remark*}[Exposition]
\textbf{NURBS connection: B\'{e}zier curve in matrix form.}
