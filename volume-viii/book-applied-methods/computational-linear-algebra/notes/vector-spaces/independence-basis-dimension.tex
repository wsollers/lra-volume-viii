...
\begin{definitionbox}{Definition (Linear Independence)}
...
\begin{definitionbox}{Definition (Basis)}
\begin{definition}[Basis]
\label{def:subspace-basis}
...
\textbf{Dimension is Well-Defined.}
...
\begin{definitionbox}{Definition (Transition Matrix)}
...
\begin{remark*}[Exposition]
\textbf{NURBS connection: Bernstein basis as a basis for polynomials.}
