...
\]
\hyperref[prf:computational-geometry-convex-hull-smallest-convex-set]{\textit{Go to proof.}}
\end{lemma}
\end{lemmabox}
...
\label{lem:computational-geometry-linear-functionals-convex-combi
nations}
...
\]
\hyperref[prf:computational-geometry-linear-functionals-convex-combi
nations]{\textit{Go to proof.}}
\end{lemma}
...
\hyperref[prf:computational-geometry-supporting-functional-hull-vertices]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
slopes.
\hyperref[prf:computational-geometry-monotone-slope-upper-hull]{\textit{Go to proof.}}
\end{theorem}
...
\hyperref[prf:computational-geometry-greedy-slope-upper-hull]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\begin{remark*}[Standard quantified statement]
The statement applies to the objects named in th
e hypotheses and asserts the
corresponding containment, extremal, or construction property stated there.
\end{remark*}
