...
This item records the local geometric concept or result used by the surrounding
...
\]
\hyperref[prf:computational-geometry-linear-functionals-convex-combinations]{\textit{Go to proof.}}
\end{lemma}
\end{lemmabox}
