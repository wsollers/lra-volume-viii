...
\begin{definitionbox}{Definition (Parametric Curve)}
\begin{definition}[Parametric Curve]
\label{def:parametric-curve}
...
\begin{definitionbox}{Definition (Velocity, Regularity, Unit Tangent)}
\begin{definition}[Velocity, Regularity, Unit Tangent]
\label{def:velocity-regularity-unit-tangent}
...
\textbf{Properties of parametric curves.}
...
\begin{definitionbox}{Definition (Parametric Surface)}
\begin{definition}[Parametric Surface]
\label{def:parametric-surface}
...
\begin{definitionbox}{Definition (Partial Derivative Vectors)}
\begin{definition}[Partial Derivative Vectors]
\label{def:partial-derivative-vectors}
...
\begin{definitionbox}{Definition (Isoparametric Curves)}
\begin{definition}[Isoparametric Curves]
\label{def:isoparametric-curves}
...
\begin{definitionbox}{Definition (Directional Derivative on a Surface)}
\begin{definition}[Directional Derivative on a Surface]
\label{def:directional-derivative-surface}
...
\begin{definitionbox}{Definition (Regularity, Unit Normal, Tangent Plane)}
\begin{definition}[Regularity, Unit Normal, Tangent Plane]
\label{def:regularity-unit-normal-tangent-plane}
...
\begin{remark*}[Exposition]
\textbf{Geometric meaning of $S_u \times S_v$.}
...
\vspace{1em}
\begin{center}
\input{volume-viii/book-applied-methods/geometric-modeling/notes/curves-and-surfaces/figure-parametric-surface}
\end{center}
