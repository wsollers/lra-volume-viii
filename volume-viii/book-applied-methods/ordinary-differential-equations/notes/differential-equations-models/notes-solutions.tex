...
\begin{itemize}
  ...
  \item \hyperref[def:ordinary-differential-equations-terminology-solution-of-a-differential-equation]{Solution of a Differential Equation}
...
\begin{itemize}
  \item \hyperref[def:ordinary-differential-equations-terminology-differential-equation]{Differential Equation}
  \item \hyperref[def:ordinary-differential-equations-solutions-initial-condition]{Initial Condition}
\end{itemize}
\end{dependencies}
...
\begin{remark*}[Interpretation]
Existence records whether the initial value problem has at least one solution
on an interval containing the initial point.
\end{remark*}

\begin{dependencies}
\begin{itemize}
  \item \hyperref[def:ordinary-differential-equations-solutions-initial-value-problem]{Initial Value Problem}
  \item \hyperref[def:ordinary-differential-equations-terminology-solution-of-a-differential-equation]{Solution of a Differential Equation}
\end{itemize}
\end{dependencies}
...
\begin{remark*}[Interpretation]
Uniqueness records whether the initial value problem has no more than one
solution on the interval under consideration.
\end{remark*}
