...
% Optional workstation-only external references for split volume builds.
% The local file is ignored and absent in CI/GitHub builds.
\InputIfFileExists{common/local-external-volume-refs.tex}{}{}
